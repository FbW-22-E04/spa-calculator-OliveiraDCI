...
const Keypad = ({
  ...
  handleResetInput,
  handleCalcKey,
  handleSignumAndPercent,
  handleDecimalPoint,
}) => {
  return (
    <section className="keypad">
      <ResetKey
        className="key upper-key"
        handleInput={handleResetInput}
        value="ac"
      />
      <AuxKey
        className="key upper-key"
        handleInput={handleSignumAndPercent}
        value="+/-"
      />
      <AuxKey
        className="key upper-key"
      ...
      <DecimalPoint
        className="key digit-key"
        handleInput={handleDecimalPoint}
        value="."
      />
      <CalcKey
        className="key operator-key"
        handleInput={handleCalcKey}
        value="="
      />
    </section>
  );
